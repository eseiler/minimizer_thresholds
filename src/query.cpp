...
void initialize_argument_parser(seqan3::argument_parser & parser, cmd_arguments & args)
{
    ...
    parser.add_option(args.window_size, 'w', "window", "Choose the window size.", seqan3::option_spec::DEFAULT,
                      seqan3::arithmetic_range_validator{1, 1000});
    parser.add_option(args.kmer_size, 'k', "kmer", "Choose the kmer size.", seqan3::option_spec::DEFAULT,
...
{
    seqan3::argument_parser myparser{"Minimizers", argc, argv, false};
    cmd_arguments args{};
